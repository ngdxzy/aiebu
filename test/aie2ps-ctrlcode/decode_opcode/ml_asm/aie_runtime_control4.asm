...
.align    16
UCBD_label_0:
	 UC_DMA_BD	 0, 0x26000000, @WRITE_data_0, 1, 0, 1
	 UC_DMA_BD	 0, 0x26000010, @WRITE_data_0, 1, 0, 0
UCBD_label_1:
	 UC_DMA_BD	 0, 0x26009000, @DMAWRITE_data_0, 0x9, 0, 0
UCBD_label_2:
	 UC_DMA_BD	 0, 0x2600931c, @WRITE_data_0, 1, 0, 0
.align    4
WRITE_data_0:
	.long 0x00000000
DMAWRITE_data_0:
