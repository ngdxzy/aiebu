...
APPLY_OFFSET_57	 @DMAWRITE_data_68, 1, 2
...
APPLY_OFFSET_57	 @DMAWRITE_data_74, 1, 3
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x108f30, @DMAWRITE_data_34, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x109500, @DMAWRITE_data_42, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109530, @DMAWRITE_data_43, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x148cf0, @DMAWRITE_data_57, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148d20, @DMAWRITE_data_58, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149200, @DMAWRITE_data_59, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149230, @DMAWRITE_data_60, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149260, @DMAWRITE_data_61, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_62, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_62, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492c0, @DMAWRITE_data_63, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492f0, @DMAWRITE_data_64, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149320, @DMAWRITE_data_65, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149350, @DMAWRITE_data_66, 0xb, 0, 1
...
UCBD_label_1:
	 UC_DMA_BD	 0, 0x18000, @DMAWRITE_data_67, 0x9, 0, 0
UCBD_label_2:
	 UC_DMA_BD	 0, 0x18030, @DMAWRITE_data_68, 0x9, 0, 0
UCBD_label_3:
	 UC_DMA_BD	 0, 0x18060, @DMAWRITE_data_69, 0x9, 0, 0
UCBD_label_4:
	 UC_DMA_BD	 0, 0x18090, @DMAWRITE_data_70, 0x9, 0, 0
UCBD_label_5:
	 UC_DMA_BD	 0, 0x180c0, @DMAWRITE_data_71, 0x9, 0, 0
UCBD_label_6:
	 UC_DMA_BD	 0, 0x180f0, @DMAWRITE_data_72, 0x9, 0, 0
UCBD_label_7:
	 UC_DMA_BD	 0, 0x18120, @DMAWRITE_data_73, 0x9, 0, 0
UCBD_label_8:
	 UC_DMA_BD	 0, 0x58000, @DMAWRITE_data_74, 0x9, 0, 0
UCBD_label_9:
