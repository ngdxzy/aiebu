...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x109290, @DMAWRITE_data_27, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1092c0, @DMAWRITE_data_28, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109500, @DMAWRITE_data_29, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109530, @DMAWRITE_data_30, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109800, @DMAWRITE_data_31, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109830, @DMAWRITE_data_32, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109860, @DMAWRITE_data_33, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109890, @DMAWRITE_data_34, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1098c0, @DMAWRITE_data_35, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1098f0, @DMAWRITE_data_36, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109920, @DMAWRITE_data_37, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109950, @DMAWRITE_data_38, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c00, @DMAWRITE_data_39, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c30, @DMAWRITE_data_40, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c60, @DMAWRITE_data_41, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c90, @DMAWRITE_data_42, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148cc0, @DMAWRITE_data_43, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149200, @DMAWRITE_data_44, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149230, @DMAWRITE_data_45, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149260, @DMAWRITE_data_46, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_47, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492c0, @DMAWRITE_data_48, 0xb, 0, 1
...
UCBD_label_1:
	 UC_DMA_BD	 0, 0x18000, @DMAWRITE_data_49, 0x9, 0, 0
UCBD_label_2:
	 UC_DMA_BD	 0, 0x18030, @DMAWRITE_data_50, 0x9, 0, 0
UCBD_label_3:
	 UC_DMA_BD	 0, 0x18060, @DMAWRITE_data_51, 0x9, 0, 0
UCBD_label_4:
	 UC_DMA_BD	 0, 0x58000, @DMAWRITE_data_52, 0x9, 0, 0
UCBD_label_5:
