...
START_JOB 1
PREEMPT	0x3c1e, @save, @restore , @hintmap_0
END_JOB
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x4150150, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x4150160, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x4150170, @WRITE_data_2, 1, 0, 1
	 UC_DMA_BD	 0, 0x4150180, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x4150190, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x41501a0, @WRITE_data_1, 1, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x4109e0c, @WRITE_data_10, 1, 0, 1
	 UC_DMA_BD	 0, 0x4149e04, @WRITE_data_10, 1, 0, 1
	 UC_DMA_BD	 0, 0x4149e0c, @WRITE_data_10, 1, 0, 1
