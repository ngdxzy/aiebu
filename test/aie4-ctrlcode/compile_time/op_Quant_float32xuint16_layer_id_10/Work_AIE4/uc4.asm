...
START_JOB 1
PREEMPT	0xe7b2, @save, @restore , @hintmap_0
END_JOB
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x4109e0c, @WRITE_data_9, 1, 0, 1
	 UC_DMA_BD	 0, 0x4149e04, @WRITE_data_9, 1, 0, 1
	 UC_DMA_BD	 0, 0x4149e0c, @WRITE_data_9, 1, 0, 1
