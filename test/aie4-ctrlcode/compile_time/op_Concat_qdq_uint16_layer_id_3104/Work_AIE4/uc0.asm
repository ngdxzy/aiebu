...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x108900, @DMAWRITE_data_11, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x108c00, @DMAWRITE_data_16, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c30, @DMAWRITE_data_17, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c60, @DMAWRITE_data_18, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c90, @DMAWRITE_data_19, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108cc0, @DMAWRITE_data_20, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108f00, @DMAWRITE_data_21, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109200, @DMAWRITE_data_22, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109230, @DMAWRITE_data_23, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109260, @DMAWRITE_data_24, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109290, @DMAWRITE_data_25, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1092c0, @DMAWRITE_data_26, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x109980, @DMAWRITE_data_36, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c00, @DMAWRITE_data_37, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c30, @DMAWRITE_data_38, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c60, @DMAWRITE_data_39, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c90, @DMAWRITE_data_40, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148cc0, @DMAWRITE_data_41, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149200, @DMAWRITE_data_42, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149230, @DMAWRITE_data_43, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149260, @DMAWRITE_data_44, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_45, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492c0, @DMAWRITE_data_46, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492f0, @DMAWRITE_data_47, 0xb, 0, 1
...
UCBD_label_1:
	 UC_DMA_BD	 0, 0x18000, @DMAWRITE_data_48, 0x9, 0, 0
UCBD_label_2:
	 UC_DMA_BD	 0, 0x18030, @DMAWRITE_data_49, 0x9, 0, 0
UCBD_label_3:
	 UC_DMA_BD	 0, 0x18060, @DMAWRITE_data_50, 0x9, 0, 0
UCBD_label_4:
	 UC_DMA_BD	 0, 0x18090, @DMAWRITE_data_51, 0x9, 0, 0
UCBD_label_5:
	 UC_DMA_BD	 0, 0x180c0, @DMAWRITE_data_52, 0x9, 0, 0
UCBD_label_6:
	 UC_DMA_BD	 0, 0x180f0, @DMAWRITE_data_53, 0x9, 0, 0
UCBD_label_7:
	 UC_DMA_BD	 0, 0x18120, @DMAWRITE_data_54, 0x9, 0, 0
UCBD_label_8:
	 UC_DMA_BD	 0, 0x18150, @DMAWRITE_data_55, 0x9, 0, 0
UCBD_label_9:
