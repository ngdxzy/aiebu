...
START_JOB 2
PREEMPT	0x92d6, @save, @restore , @hintmap_0
END_JOB

.eop
pdi:
.include ../op_Quant_float32xuint16_layer_id_0/Work_AIE4/pdi.asm
.endl pdi
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x148000, @DMAWRITE_data_11, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148030, @DMAWRITE_data_12, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148300, @DMAWRITE_data_13, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148330, @DMAWRITE_data_14, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c00, @DMAWRITE_data_15, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c30, @DMAWRITE_data_16, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c60, @DMAWRITE_data_17, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x108c90, @DMAWRITE_data_18, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109200, @DMAWRITE_data_19, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109230, @DMAWRITE_data_20, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109260, @DMAWRITE_data_21, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109290, @DMAWRITE_data_22, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109800, @DMAWRITE_data_23, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109830, @DMAWRITE_data_24, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c00, @DMAWRITE_data_25, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c30, @DMAWRITE_data_26, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c60, @DMAWRITE_data_27, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148c90, @DMAWRITE_data_28, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149200, @DMAWRITE_data_29, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149230, @DMAWRITE_data_30, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149260, @DMAWRITE_data_31, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_32, 0xb, 0, 1
...
UCBD_label_1:
	 UC_DMA_BD	 0, 0x18000, @DMAWRITE_data_33, 0x9, 0, 0
UCBD_label_2:
	 UC_DMA_BD	 0, 0x18030, @DMAWRITE_data_34, 0x9, 0, 0
UCBD_label_3:
	 UC_DMA_BD	 0, 0x18060, @DMAWRITE_data_35, 0x9, 0, 0
UCBD_label_4:
	 UC_DMA_BD	 0, 0x18090, @DMAWRITE_data_36, 0x9, 0, 0
UCBD_label_5:
...
UCBD_label_7:
	 UC_DMA_BD	 0, 0x109e64, @WRITE_data_3, 1, 0, 0
UCBD_label_8:
	 UC_DMA_BD	 0, 0x109e74, @WRITE_data_3, 1, 0, 0
UCBD_label_9:
	 UC_DMA_BD	 0, 0x149e64, @WRITE_data_3, 1, 0, 0
UCBD_label_10:
