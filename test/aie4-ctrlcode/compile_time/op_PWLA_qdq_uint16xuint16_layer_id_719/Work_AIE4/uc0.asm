...
START_JOB 1
PREEMPT	0xc5a9, @save, @restore , @hintmap_0
END_JOB
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x109200, @DMAWRITE_data_21, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109230, @DMAWRITE_data_22, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109260, @DMAWRITE_data_23, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109290, @DMAWRITE_data_24, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1092c0, @DMAWRITE_data_25, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109800, @DMAWRITE_data_26, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x109830, @DMAWRITE_data_27, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x148c90, @DMAWRITE_data_31, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x148cc0, @DMAWRITE_data_32, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149200, @DMAWRITE_data_33, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149230, @DMAWRITE_data_34, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149260, @DMAWRITE_data_35, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x149290, @DMAWRITE_data_36, 0xb, 0, 1
	 UC_DMA_BD	 0, 0x1492c0, @DMAWRITE_data_37, 0xb, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x150010, @WRITE_data_1, 1, 0, 1
...
UCBD_label_5:
	 ...
	 UC_DMA_BD	 0, 0x18554, @WRITE_data_4, 1, 0, 1
...
UCBD_label_6:
	 ...
	 UC_DMA_BD	 0, 0x149e0c, @WRITE_data_2, 1, 0, 0
UCBD_label_7:
	 UC_DMA_BD	 0, 0x109e64, @WRITE_data_0, 1, 0, 0
UCBD_label_8:
	 UC_DMA_BD	 0, 0x109e74, @WRITE_data_0, 1, 0, 0
UCBD_label_9:
	 UC_DMA_BD	 0, 0x149e64, @WRITE_data_0, 1, 0, 0
UCBD_label_10:
	 UC_DMA_BD	 0, 0x149e74, @WRITE_data_0, 1, 0, 1
	 UC_DMA_BD	 0, 0x109e84, @WRITE_data_2, 1, 0, 0
.align    4
DMAWRITE_data_0:
	.long 0x0081b8e0
	.long 0xfe003700
