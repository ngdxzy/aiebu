...
START_JOB 1
PREEMPT	0x4646, @save, @restore , @hintmap_0
END_JOB
...
UCBD_label_0:
	 ...
	 UC_DMA_BD	 0, 0x150150, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x150160, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x150170, @WRITE_data_2, 1, 0, 1
	 UC_DMA_BD	 0, 0x150180, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x150190, @WRITE_data_1, 1, 0, 1
	 UC_DMA_BD	 0, 0x1501a0, @WRITE_data_1, 1, 0, 1
	 ...
	 UC_DMA_BD	 0, 0x109e0c, @WRITE_data_9, 1, 0, 1
	 UC_DMA_BD	 0, 0x149e04, @WRITE_data_9, 1, 0, 1
	 UC_DMA_BD	 0, 0x149e0c, @WRITE_data_9, 1, 0, 1
