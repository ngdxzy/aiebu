...
APPLY_OFFSET_57	 @DMAWRITE_data_0, 1, 65535, @preempt_buffer0
APPLY_OFFSET_57	 @DMAWRITE_data_1, 1, 65535, @preempt_buffer0
APPLY_OFFSET_57	 @DMAWRITE_data_2, 1, 65535, @preempt_buffer0
APPLY_OFFSET_57	 @DMAWRITE_data_3, 1, 65535, @preempt_buffer0
